...
describe('js-output', () => {
	fs.readdirSync(`${__dirname}/samples`).forEach((dir) => {
		...
		const skip = !fs.existsSync(`${resolved}/input.poly`);
		if (skip) {
			console.warn(
				`Missing file ${dir}/input.poly. If you recently switched branches you may need to delete this directory`
			);
		}
		...
		it_fn(dir, async () => {
			...
			const input = fs
				.readFileSync(`${resolved}/input.poly`, 'utf-8')
				.trimEnd()
				.replace(/\r/g, '');
