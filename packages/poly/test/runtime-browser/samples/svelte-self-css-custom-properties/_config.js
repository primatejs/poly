export default {
	...
	html: `
		<div style="display: contents; --rail-color:rgb(0, 0, 0); --track-color:rgb(255, 0, 0);">
			<div id="component1">
				<p class="poly-q538ga">Slider1</p><span class="poly-q538ga">Track</span>
			</div>
			<div style="display: contents; --rail-color:rgb(255, 255, 0); --track-color:rgb(255, 0, 255);">
				<div id="nest-component1">
					<p class="poly-q538ga">Slider1</p><span class="poly-q538ga">Track</span></div>
				</div>
			</div>
		<div style="display: contents; --rail-color:rgb(0, 255, 0); --track-color:rgb(0, 0, 255);">
			<div id="component2">
				<p class="poly-q538ga">Slider2</p><span class="poly-q538ga">Track</span>
			</div>
