...
export default {
	...
	test({ assert, target }) {
		...
		assert.deepEqual(h1.__poly_meta.loc, {
			...
			line: 5, // line 4 in main.poly, but that's the preprocessed code, the original code is above in the fake preprocessor
			column: 1, // line 0 in main.poly, but that's the preprocessed code, the original code is above in the fake preprocessor
