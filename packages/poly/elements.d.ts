// Type definitions for Poly HTML, based on JSX React 18 typings
...
// Note: We also allow `null` as a valid value because Poly treats this the same as `undefined`
...
export interface HTMLAttributes<T extends EventTarget> extends AriaAttributes, DOMAttributes<T> {
	...
	// PolyKit
	'data-polykit-keepfocus'?: true | '' | 'off' | undefined | null;
	'data-polykit-noscroll'?: true | '' | 'off' | undefined | null;
	'data-polykit-preload-code'?:
		| true
		| ''
		| 'eager'
		| 'viewport'
		...
		| undefined
		| null;
	'data-polykit-preload-data'?: true | '' | 'hover' | 'tap' | 'off' | undefined | null;
	'data-polykit-reload'?: true | '' | 'off' | undefined | null;
	'data-polykit-replacestate'?: true | '' | 'off' | undefined | null;
...
export interface HTMLMediaAttributes<T extends HTMLMediaElement> extends HTMLAttributes<T> {
	...
	readonly 'bind:buffered'?: PolyMediaTimeRange[] | undefined | null;
	readonly 'bind:played'?: PolyMediaTimeRange[] | undefined | null;
	readonly 'bind:seekable'?: PolyMediaTimeRange[] | undefined | null;
...
export interface PolyMediaTimeRange {
	start: number;
	end: number;
}

export interface PolyDocumentAttributes extends HTMLAttributes<Document> {
...
export interface PolyWindowAttributes extends HTMLAttributes<Window> {
	...
	// PolyKit
	'on:polykit:start'?: EventHandler<CustomEvent, Window> | undefined | null;
	'on:polykit:navigation-start'?: EventHandler<CustomEvent, Window> | undefined | null;
	'on:polykit:navigation-end'?: EventHandler<CustomEvent, Window> | undefined | null;
...
export interface PolyHTMLElements {
	...
	// Poly specific
	'svelte:window': PolyWindowAttributes;
	'svelte:document': PolyDocumentAttributes;
		...
		customElement?:
			...
			| {
					...
					props?:
						...
						| undefined;
					extend?: (
						polyCustomElementClass: new () => HTMLElement
