...
export default class EachBlockWrapper extends Wrapper {
  ...
  render(block, parent_node, parent_nodes) {
    ...
    if (this.else) {
      ...
      `);
      const has_transitions = Boolean(this.else.block.has_intro_method || this.else.block.has_outro_method);
  ...
  render_unkeyed({
    ...
    `);
    if (this.dependencies.size) {
      const has_transitions = Boolean(this.block.has_intro_method || this.block.has_outro_method);
