...
function validate_options(options, warnings) {
  if (/** @type {any} */ options.format) {
    if (!warned_of_format) {
      ...
      console.warn(
        "The format option has been removed in Poly 4, the compiler only outputs ESM now. Remove \"format\" from your compiler options. " +
          "If you did not set this yourself, bump the version of your bundler plugin (vite-plugin-poly/rollup-plugin-poly/svelte-loader)",
      );
    }
