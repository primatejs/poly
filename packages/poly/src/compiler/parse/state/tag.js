import { extract_poly_ignore } from "../../utils/extract_poly_ignore.js";
...
export default function tag(parser) {
  ...
  if (parser.eat("!--")) {
    ...
    parser.current().children.push({
      ...
      type: "Comment",
      data,
      ignores: extract_poly_ignore(data),
    });
    return;
  }
  ...
  try {
    value = read_sequence(
      ...
      () => {
        ...
        return Boolean(parser.match_regex(regex_starts_with_invalid_attr_value));
      },
      "in attribute value",
    );
  } catch (error) {
